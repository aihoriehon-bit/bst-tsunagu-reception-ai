...
const manifest = JSON.parse(readFileSync(new URL('../wide-desk-preview/audio/kana/bank.json', import.meta.url)));
const file = readFileSync(new URL('../wide-desk-preview/audio/kana/bank.wav', import.meta.url));
