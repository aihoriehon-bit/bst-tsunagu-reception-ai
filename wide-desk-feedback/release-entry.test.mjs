...
test('comparison and approved main entry both use the latest feedback runtime', () => {
  ...
  assert.match(root, /src="\.\.\/wide-desk-feedback\/app.js\?v=20260915-turn-bottom-1"/);
  assert.match(root, /href="\.\.\/wide-desk-feedback\/preview.css\?v=20260915-turn-bottom-1"/);
});
